...
<div class="container" id="header">
    ...
    <div class="abso_box">
        <div class="row">
            <div class="col-md-12">
                <div class="carousel owl-theme slide article-slide" id="myCarousel">
                    <div class="carousel-inner cont-slider">
                        <div class="item active">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/img/image2.jpg')}}">
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{asset('assets/img/image3.jpg')}}">
                                </div>
                                <div class="col-md-6">
                                    <h2>The standard lorem ipsum passage</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit pariatur sint harum, quae officiis nemo, dicta iste magni nihil ipsam provident neque minima incidunt, ratione nisi dolor perferendis quis alias.</p>
                    ...
                    <ol class="carousel-indicators visible-lg visible-md">
                        <li class="active" data-slide-to="0" data-target="#myCarousel">
                            <img alt="" title="" src="{{asset('assets/img/image2.jpg')}}">
                        </li>
                        <li data-slide-to="1" data-target="#myCarousel">
                            <img alt="" title="" src="{{asset('assets/img/image3.jpg')}}">
                        </li>
                        <li data-slide-to="2" data-target="#myCarousel">
                            <img alt="" title="" src="{{asset('assets/img/image4.jpg')}}">
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <div id="explore_our_merch_carousel" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item active">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a href="#" class="thumbnail"><img src="assets/img/image4.jpg" alt="Image" style="max-width:100%;"></a>
                                        </div>
                                         <div class="col-md-3">
                                            <a href="#" class="thumbnail"><img src="assets/img/image3.jpg" alt="Image" style="max-width:100%;"></a>
                                        </div>
                                         <div class="col-md-3">
                                            <a href="#" class="thumbnail"><img src="assets/img/image4.jpg" alt="Image" style="max-width:100%;"></a>
                                        </div>
